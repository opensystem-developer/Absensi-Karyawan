  ...
  return (
    <form onSubmit={(e) => { e.preventDefault(); onSubmit(); }}>
      ...
      <div className="form-grid">
        ...
        <Field label="Tgl Mulai"><DateInput value={form.start_date} onChange={set('start_date')} /></Field>
        <Field label="Tgl Akhir"><DateInput value={form.end_date} onChange={set('end_date')} /></Field>
